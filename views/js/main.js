...
//  Moved the determineDX function call out of the loop
//  Moved the newwidth calculation out of loop
//  Optomized loop
    function changePizzaSizes(size) {
        ...
        var newwidth =
            (randomPie[0].offsetWidth + dx) + 'px';
        var counts = randomPie.length;
...
//  Optimized loops contained in updatePositions function and the onDOMContentLoaded event handler
//  Moved scrollTop calculation outside of loop
function updatePositions() {
    frame++;
//  Changed querySelectorAll() with getElementsByClassName() for better performance on the DOM querying.	
...
//  Dynamically calculated the amount of pizzas to add to page based on width of page

document.addEventListener('DOMContentLoaded', function() {
    var cols = 8;
    var s = 256;

    var numPizza = (window.screen.height / 100) * (window.screen.width / s);
    var elem;
